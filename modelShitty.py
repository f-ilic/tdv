...
class L1DenoiseDataterm(Dataterm):
    def __init__(self, config):
...
class VNet(torch.nn.Module):
    ...
    def __init__(self, config, efficient=False):
        ...
        if config['lambda_mode'] == 'fixed':
            ...
            self.lmbda = torch.nn.Parameter(torch.Tensor(10))
        ...
        regs = {'l1':TVRegularizer.TVRegularizerL1,
                'l2':TVRegularizer.TVRegularizerL2,
                }
        self.R = regs[config['R']['type']]()
        print("Reg:", self.R)
